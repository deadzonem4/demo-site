...
const BgFootballNews = props => {
  ...
  const [isLoading, fetchedData] = useHttps(
    `https://articles/search?query=%2A&category=2019061322524688039&page=${props.page}`,
    '',
    []
  );  
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-8 col-sm-12 custom-mobile-grid">
        ...
        <ArticlePages fullData={fetchedData} pageLink="/articles/bg-football/"/>
      </div>
      <Sidebar/>
    </div>
  );
